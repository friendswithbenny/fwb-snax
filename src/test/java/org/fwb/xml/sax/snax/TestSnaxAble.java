...
public class TestSnaxAble {
	...
	static final SnaxAble CHILD2 = new SnaxAble() {
		...
		public void toSnax(SmartContentHandler sch) throws SAXException {
			...
			sch.startElement("theSecondChild");
				sch.addAttribute("hair", "blonde");
				sch.addAttribute("type", "snazzy snax able");
				sch.characters("some char broil too");
			sch.endElement();
		}
	};
	
	static final String EXPECTED = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><theElementName secondAttribution=\"some value\" firstAtt=\"thirteen\">"
...
//		t.setOutputProperty(OutputKeys.STANDALONE, "yes");
		...
		t.transform(
				new SnaxSource(
						new SnaxAdapter(NAME, ATTS, Arrays.<SnaxAble>asList(
